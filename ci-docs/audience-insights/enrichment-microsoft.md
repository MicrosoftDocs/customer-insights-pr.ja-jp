...
ブランド アフィニティと SoV エンリッチメントを構成するには、**検出** タブに移動し、**ブランド** タイルで **データのエンリッチ** を選択します。

関心アフィニティと SoV エンリッチメントを構成するには、**検出** タブに移動し、**関心** タイルで **データのエンリッチ** を選択します。
...
**エンリッチされたエンティティ** を選択し、Microsoft からのデータでエンリッチするデータ セットを選択します。 顧客エンティティを選択してすべての顧客プロファイルをエンリッチするか、セグメント エンティティを選択してそのセグメントに含まれる顧客プロファイルのみをエンリッチします。
...
一定期間にエンリッチされた顧客プロファイルの数と、エンリッチされたエンティティのプレビューを示すグラフが表示されます。 **アフィニティ レベル** または **シェア オブ ボイス** のグラフにある **さらに表示** を選択して、エンリッチされたデータを確認します。 ブランドのエンリッチされたデータは、**BrandAffinityFromMicrosoft** および **BrandShareOfVoiceFromMicrosoft** エンティティに移動します。 関心のデータは、**InterestAffinityFromMicrosoft** および **InterestShareOfVoiceFromMicrosoft** エンティティにあります。 これらのエンティティは、 **データ** > **エンティティ** の **強化** グループにて一覧表示されます。
