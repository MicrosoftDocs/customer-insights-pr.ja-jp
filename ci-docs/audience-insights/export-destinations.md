...
**ビジネス 取引先企業 (B2B) または個人顧客 (B2C) の環境でのセグメントのエクスポート**  
ほとんどのエクスポート オプションは、両方のタイプの環境をサポートします。 セグメントをさまざまなターゲット システムにエクスポートするには、特定の要件があります。 一般的に、顧客プロファイルであるセグメント メンバーには連絡先情報が含まれています。 これは通常、個々の顧客に基づいて構築されたセグメント (B2C) に当てはまりますが、ビジネス 取引先企業に基づくセグメント (B2B) には必ずしも当てはまりません。 

**ビジネス アカウントのセグメント エクスポート環境 (B2B)**  
